...
export default function Id(): ReactElement {
    ...
    const refreshData = async () => {
        setIsLoading(true)
        try {
            const res: any = await API.get(`dashboard/skills/${id}`)
            if (res.data) {
                setIsLoading(false)
    ...
    const saveData = async (e) => {
        ...
        try {
            ...
            if (res.status == 201 || res.status == 200 || res.status == 202 || res.status == 203) {
                ...
                router.push('/dashboard/cms/skills')
            } else {
                alert('Error')
            }
        } catch (error) {
            ...
            <div className="panel-modal lg modal-add-new">
                <div className="panel-modal-header">
                    ...
                    <div className="panel-modal-left-tools">
                        <button onClick={() => router.push('/dashboard/cms/skills')} className="close-modal">
                ...
                <form onSubmit={saveData}>
                        ...
                        <div className="row">
                            <div className="col-sm-4">
                                <div className="timlands-form">
                                    <label className="label-block" htmlFor="name_ar">اسم المهارة بالعربي</label>
                                    <input
                                        type="text"
                                        id="name_ar"
                                        name="name_ar"
                            ...
                            <div className="col-sm-4">
                                <div className="timlands-form">
                                    <label className="label-block" htmlFor="name_en">اسم المهارة بالانجليزي</label>
                                    <input
                                        type="text"
                                        id="name_en"
                                        name="name_en"
                            ...
                            <div className="col-sm-4">
                                <div className="timlands-form">
                                    <label className="label-block" htmlFor="name_fr">اسم المهارة بالفرنسي</label>
                                    <input
                                        type="text"
                                        id="name_fr"
                                        name="name_fr"
                    ...
                    <div className="panel-modal-footer">
                        <button onClick={() => router.push('/dashboard/cms/skills')} type="button" className="btn butt-red butt-sm">إغلاق</button>
