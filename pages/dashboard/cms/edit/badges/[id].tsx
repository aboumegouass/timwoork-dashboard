                        ...
                        <div className="row">
                            <div className="col-sm-4">
                                <div className="timlands-form">
                                    <label className="label-block" htmlFor="name_ar">اسم الشارة بالعربي</label>
                                    <input
                                        type="text"
                                        id="name_ar"
                                        name="name_ar"
                            ...
                            <div className="col-sm-4">
                                <div className="timlands-form">
                                    <label className="label-block" htmlFor="name_en">اسم الشارة بالانجليزي</label>
                                    <input
                                        type="text"
                                        id="name_en"
                                        name="name_en"
                            ...
                            <div className="col-sm-4">
                                <div className="timlands-form">
                                    <label className="label-block" htmlFor="name_fr">اسم الشارة بالفرنسي</label>
                                    <input
                                        type="text"
                                        id="name_fr"
                                        name="name_fr"
